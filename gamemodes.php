...
<html>
  <head>
    <title>Gamemodes - Overcast Network Wiki</title>
        ...
        <div class="tabbable tabs-left">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab1">
              ...
              <hr>
              <p>The objective of these maps is to go to the other team's side, and get the wool in their wool rooms, which are filled with special items so you can escape, and run back to your side to place the wool. You must defend your side's wool rooms and at the same time capture the other team's wool. It is probably more difficult than any other gamemode.</p>
              <strong>
                <p>Terminology:</p>
              </strong>
            ...
            <div class="tab-pane" id="tab2">
              ...
              <p>Positioning: In this gamemode players could choose if they want to be attackers and break the monument, stay back as midfielders at the front lines and keep the enemy attackers back or act as defenders and keep the monument from being broken. This is generally done by exposing the obsidian, placing buttons on the monument, or placing pressure plates underneath the monument.</p>
              <strong>
                <p>Terminology:</p>
              </strong>
              <p>Tunnellers: Players that mine their way through the enemy's side until they reach the monument.</p>
              <p>Rushers: Players that rush to the enemy's side right at the beginning of the match.</p>
            </div>
            <div class="tab-pane" id="tab3">
              ...
              <p>Objective: The objective is to break the obsidian core and have the lava leak out. 15 minutes into the game, the obsidian material changes to gold, making the breaking of it easier. After 20 minutes the gold core will change into glass.</p>
              <p>Maps: Most DTC maps only have one core, though a few have two such as Inheritance, Battle of Tenjin 2 or Total War.</p>
              <p>Positioning: Typically there are three different positions a player can play. The rusher will aim to leak the core and have the lava flow out of it. Midfielders will try and hold no-man's-land for their team and the defenders' aim is to keep their core from leaking at all costs. This is typically done by covering the core with water, making the leaking of the core a lot harder.</p>
              <strong>
                <p>Terminology:</p>
              </strong>
              <p>Tunnellers: Players that mine their way through the enemy's side until they reach the core.</p>
              <p>Rushers: Players that rush to the enemy's side right at the beginning of the match.</p>
            </div>
            ...
            <div class="tab-pane" id="tab11">
              <h2>Blasternauts</h2>
              <hr>
              <p>Blasternauts is a special type of TDM where you have to kill the enemy team(s) using only TNT, grenades, and other explosive goods! Whichever team reaches the most points within a certain amount of time wins! This gamemode was created by ItsMiiOlly and has been carried out in currently 3 maps; BN: Classic, BN: Overdrive, BN: Spacecraft and BN: Obsidizone.</p>
            </div>
            ...
            <div class="tab-pane" id="tab13">
              ...
              <hr>
              <p>You are given a set amount of classes and your goal is to take out the other enemy's king! There is only 1 king and you have 2 lives. The king also has two lives. Whoever defeats the enemy's king first wins!</p>
            </div>
          </div>
        </div>
      </div>
