					...
					<div class="tab-pane active" id="tab1">
						<div class="container">
							<div class="col-md-9">
								...
								<h5>Block Hitting</h5>
								<p>
									This is blocking and hitting with your sword at the same time.
								</p>
								<p>
						...
						<div class="container">
							<div class="col-md-9">
								...
								<ul>
									...
									<li>
										0scavenger0 -&nbsp;<a href="http://www.youtube.com/user/0scavenger0PvP">http://www.youtube.com/user/0scavenger0PvP</a>
									</li>
									<li>
										pmheys -&nbsp;<a href="http://www.youtube.com/user/paulmheys">http://www.youtube.com/user/paulmheys</a>
									</li>
									<li>
										Cayden -&nbsp;<a href="http://www.youtube.com/user/TheBaconlube">http://www.youtube.com/user/TheBaconlube</a>
									</li>
									<li>
										N3XT_M3CH_P0W3R -&nbsp;<a href="http://www.youtube.com/user/ignN3XT">http://www.youtube.com/user/ignN3XT</a>
									</li>
									<li>
										daeshik -&nbsp;<a href="http://www.youtube.com/user/LaxCrafft">http://www.youtube.com/user/LaxCrafft</a>
									</li>
									<li>
										Tethius -&nbsp;<a href="http://www.youtube.com/user/TethiusMC">http://www.youtube.com/user/TethiusMC</a>
									</li>
									<li>
										Jtpetino -&nbsp;<a href="http://www.youtube.com/user/jtpetino">http://www.youtube.com/user/jtpetino</a>
									</li>
									<li>
									...
									<li>
										wojciech10 -&nbsp;<a href="http://www.youtube.com/user/MrWojciech10">http://www.youtube.com/user/MrWojciech10</a>&nbsp;(Small guides on pot pvp)
									</li>
									<li>
										LazersMyName -&nbsp;<a href="http://www.youtube.com/user/LazersTheGame">http://www.youtube.com/user/LazersTheGame</a>
									</li>
									<li>
										CaptainMike15 -&nbsp;<a href="http://www.youtube.com/user/captainmike555">http://www.youtube.com/user/captainmike555</a>
									</li>
									<li>
								...
								<b>Archery</b>:&nbsp;Basically using your bow.
								<br><br>
								<ul>
									<li>
								...
								<b>Special Tactics (<i>Archery</i>)</b>:
								<br>
								<ul>
									<li>
								...
								<br>
								There are 3 main different types of pvp. Potion pvp, soup pvp and Non-Enchant.
								<br>
								<ul>
									<li>
								...
								mc.kohicraft.net
								<br>
								us.shotbow.net (civcraft or hcfactions portal)
								<br>
								eu.shotbow.net (civcraft or hcfactions portal)
								<br><br>
								<b><u>Soup</u></b>
								<u><b>(I only know a few but it is the most popular so just search for it)</b></u>
								<br>
								mckits.com
								<br>
								skylandkits.com
								...
								<b><u>Archery</u></b>
								<br>
								us.shotbow.net (Minez portal)
								<br>
								eu.shotbow.net (Minez portal)
								<br>
								Find a thing about RMCT
								<br>
								mcctf.com - pick archer class.
								<br>
								<div>
									<div>
										<div>
								...
								<ul>
									...
									<li>
										If you spam your sprint key you get extra knockback (<b>True</b>)
									</li>
								</ul>
								<br>
								<b>How KD works by FunnyQuinn <a href="https://oc.tc/forums/topics/51d4bfadba6087bc9e0037fc">https://oc.tc/forums/topics/51d4bfadba6087bc9e0037fc</a></b>
								<br>
								If you have any improvements please tell me and if you liked the guide
								<br>
							</div>
						</div>
					</div>
